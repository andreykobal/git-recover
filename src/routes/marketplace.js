...
const categories = [
  ...
  },
  {
    name: 'Weapons',
    href: '#',
    imageSrc: 'https://itforeveryone.org/wp-content/uploads/2022/06/photo5242556593713822166.jpg',
  },
  {
    name: 'Vehicles',
    href: '#',
    imageSrc: 'https://itforeveryone.org/wp-content/uploads/2022/06/photo5242556593713822167.jpg',
  },
  {
    name: 'Real Estate',
    href: '#',
  ...
  { name: 'Land', href: '#', imageSrc: 'https://itforeveryone.org/wp-content/uploads/2022/06/photo5242556593713822166.jpg' },
]
const collections = [
  {
    ...
    <div className="bg-white">
      ...
      <div className="relative bg-gray-900">
        ...
        <div aria-hidden="true" className="absolute inset-0 overflow-hidden">
          <img
            src="https://itforeveryone.org/wp-content/uploads/2022/06/photo5424924633133594818.jpg"
            alt=""
        ...
        <div className="relative max-w-3xl mx-auto py-32 px-6 flex flex-col items-center text-center sm:py-64 lg:px-0">
          <h1 className="text-4xl font-extrabold tracking-tight text-white lg:text-6xl">Playable NFT Marketplace</h1>
      ...
      <main>
          ...
          <div className="relative rounded-lg overflow-hidden">
            ...
            <div className="relative bg-gray-900 bg-opacity-75 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
              <div className="relative max-w-3xl mx-auto flex flex-col items-center text-center">
                ...
                >
                  <span className="block sm:inline">Your digital property is entirely yours</span>
                </h2>
        ...
        <section aria-labelledby="comfort-heading" className="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          <div className="relative rounded-lg overflow-hidden">
            <div className="absolute inset-0">
              <img
                src="https://itforeveryone.org/wp-content/uploads/2022/04/photo_2022-04-20-22.05.35.jpeg"
                alt=""
                className="w-full h-full object-center object-cover"
              />
            </div>
            <div className="relative bg-gray-900 bg-opacity-75 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
              <div className="relative max-w-3xl mx-auto flex flex-col items-center text-center">
                ...
                New NFT standard for playable assets
                </h2>
                <p className="mt-3 text-xl text-white">
