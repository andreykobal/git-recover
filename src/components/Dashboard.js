        ...
        <Dialog as="div" className="fixed inset-0 flex z-40 lg:hidden" onClose={setSidebarOpen}>
          ...
          >
            <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-purple-700">
              ...
              <nav className="mt-5 flex-shrink-0 h-full divide-y divide-purple-800 overflow-y-auto" aria-label="Sidebar">
                  ...
                  {navigation.map((item) => (
                    <a
                      ...
                      className={classNames(
                        item.current ? 'bg-purple-800 text-white' : 'text-purple-100 hover:text-white hover:bg-purple-600',
                        'group flex items-center px-2 py-2 text-base font-medium rounded-md'
                      )}
                      aria-current={item.current ? 'page' : undefined}
                    >
                      <item.icon className="mr-4 flex-shrink-0 h-6 w-6 text-purple-200" aria-hidden="true" />
                      {item.name}
                    </a>
                  ))}
                </div>
                  ...
                  <div className="px-2 space-y-1">
                    {secondaryNavigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="group flex items-center px-2 py-2 text-base font-medium rounded-md text-purple-100 hover:text-white hover:bg-purple-600"
                      >
                        <item.icon className="mr-4 h-6 w-6 text-purple-200" aria-hidden="true" />
                        {item.name}
                      </a>
                    ))}
                  </div>
      ...
      <div className="hidden lg:flex lg:flex-shrink-0">
        <div className="flex flex-col w-64">
          ...
          <div className="flex flex-col flex-grow bg-purple-700 pt-5 pb-4 overflow-y-auto">
            ...
            <nav className="mt-5 flex-1 flex flex-col divide-y divide-purple-800 overflow-y-auto" aria-label="Sidebar">
              <div className="px-2 space-y-1">
                {navigation.map((item) => (
                  <a
                    key={item.name}
                ...
                <div className="px-2 space-y-1">
                  {secondaryNavigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md text-purple-100 hover:text-white hover:bg-purple-600"
                    >
                      <item.icon className="mr-4 h-6 w-6 text-purple-200" aria-hidden="true" />
                      {item.name}
                    </a>
                  ...
                  <div key={card.name} className="bg-white overflow-hidden shadow rounded-lg">
                    ...
                    <div className="bg-gray-50 px-5 py-3">
                      <div className="text-sm">
                        <a href={card.href} className="font-medium text-purple-700 hover:text-purple-900">
                          View all
                        </a>
                      </div>
                    </div>
